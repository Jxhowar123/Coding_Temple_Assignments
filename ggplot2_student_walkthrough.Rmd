...
Whoa, where'd count come from? **Count is not a variable or attribute of the variable dia monds!** Count comes automatically with a lot of graphs as an attribute. You can verify what I'm saying with `?diamonds` in the console.
...
#ggplot(data = nycflights13::airports)+
  geom_map(mapping = aes(x = lon, y = lat, map_id = tzone ))
```
